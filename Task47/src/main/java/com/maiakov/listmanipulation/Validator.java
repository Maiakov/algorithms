...
public class Validator {
    ...
    public static void validateInputParameters(Node headOfList, Node nodeToAdd, int index) {
        validateInputParameters(headOfList, nodeToAdd);
        validateIndex(headOfList, index);
    }

    public static void validateIndex(Node headOfList, int index) {
